<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CBR-250.aspx.cs" Inherits="Bikes_Pages_CBR_250" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:Label ID="Label2" runat="server" Font-Names="Arial" Font-Size="XX-Large" 
            ...
            style="text-align: center; float: none" >CBR 250</asp:Label>
        <br />
        <br />
        <br />
        <br />
     ...
     <br />
        ...
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label6" runat="server" Text="The Honda CBR 250  is a great two wheeler to own. It is a bike with all the latest technical features which are making it a rage among the youngsters. The bike
          " Font-Size="Medium" ForeColor="#666666"></asp:Label>
  <br />       
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <asp:Label ID="Label7" runat="server" ForeColor="#666666" 
         Text=" looks heavy but it is easy to control . The Honda CBR 250 is loaded with gorgeous styling, superior comfort and host of latest tech features like ExhausTEC and a mechanism"></asp:Label>
     <br />
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label10" 
         ...
         Text="Honda CBR 250  is a fuel efficient bike. It has liquid cooling and “electric-start” features; that is the reason that it consumes less fuel. Normally"></asp:Label>
     <br />
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <asp:Label ID="Label11" runat="server" ForeColor="#666666" 
         Text="Honda CBR 250 provides a mileage of 60kmpl with gasoline. It has a fuel tank capacity of 20 litres, which is enough to last for more than 200km. It has a nice"></asp:Label>
     <br />
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <asp:Label ID="Label12" runat="server" ForeColor="#666666" 
         Text="acceleration as it comes with a 250cc engine that provides dynamic transmission.Honda CBR 250  has a four stroke engine that offers zipper acceleration."></asp:Label>
     <br />
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label14" runat="server" 
         ForeColor="#666666" Text="It is priced at"></asp:Label>
     &nbsp;<asp:Label ID="Label13" runat="server" ForeColor="#993333" 
         Text="Rs 115000* ."></asp:Label>
     <br />
     <br />
     <br />
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <asp:Image ID="Image3" runat="server" Height="265px" 
         ImageUrl="~/BikeImages/nonsports/CBR250R-MetallicBlack.jpg" 
         Width="430px" />
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <asp:Image ID="Image4" runat="server" Height="265px" 
         ImageUrl="~/BikeImages/nonsports/CBR250R-RedSilver.jpg" Width="430px" />
     <br />
     <br />
     <br />
     <br />
     ...
     <asp:Panel ID="Panel2" runat="server" BackColor="#CCCCCC" BorderColor="White" 
         ...
         <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Names="Arial" 
             Text="Honda CBR 250   Color"></asp:Label>
     </asp:Panel>
     <br />
     <br />
     <br />
     ...
     <asp:Label ID="Label15" runat="server" ForeColor="#666666" 
         Text=" The state of the art technology offered by Honda, makes Honda CBR 250  a bike with a difference. It has better maneuverability and it makes its owner proud."></asp:Label>
     <br />
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     <asp:Label ID="Label17" runat="server" ForeColor="#666666" 
         Text=" better vision at night and at the same time, they look extremely good too. The look of Honda CBR 250  is bound of attract eyeballs."></asp:Label>
     <br />
     <br />
                             ...
                             <tr>
                                 <td>
                                     <asp:Panel ID="Panel3" runat="server" 
                                         BackImageUrl="~/BikeImages/nonsports/CBR250R-RedSilver.jpg" Height="258px" 
                                         Width="470px">
                                     </asp:Panel>
                                 </td>
                                 <td>
                                     ...
                                     <asp:ImageButton ID="ImageButton2" runat="server" Height="55px" 
                                         ImageUrl="~/BikeImages/nonsports/CBR250R-RedSilver-button.jpg" 
                                     ...
                                     <asp:ImageButton ID="ImageButton3" runat="server" Height="55px" 
                                         ImageUrl="~/BikeImages/nonsports/CBR250R-WhitePearlBlueRed-button.jpg" 
                                         onclick="ImageButton3_Click" Width="76px" ToolTip="WhitePearlBlueRed" />
                                 </td>
                             </tr>
                         </table>
                     </td>
     ...
     <asp:Panel ID="Panel4" runat="server" BackColor="#CCCCCC" BorderColor="White" 
         ...
         <asp:Label ID="Label18" runat="server" Font-Bold="True" Font-Names="Arial" 
             Text="Honda CBR 250  Engine Specifications/Features"></asp:Label>
     </asp:Panel>
     <br />
     <br />
     <br />
                     ...
                     <tr>
                         ...
                         <td align="center">
                             <asp:Table ID="Table1" runat="server" BackColor="#CCCCFF" BorderColor="#999999" 
                                 ...
                                 <asp:TableRow>
                                     <asp:TableCell>Honda CBR 250 </asp:TableCell>
                                     <asp:TableCell> Displacement : 250cc <br />
                    Engine :250cc,Type V-Twin  <br />
                         ...
                         <td>
                             <asp:Panel ID="Panel5" runat="server" BorderColor="Red" BorderStyle="Inset" 
                                 ...
                                 <asp:Label ID="Label19" runat="server" Font-Bold="True" Font-Names="Aparajita" 
                                     ...
                                     Text="Features of Honda CBR 250 "></asp:Label>
                                 <br />
                                 <br />
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; *&nbsp;
