<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Harley-VRSC.aspx.cs" Inherits="Bikes_Pages_Harley_VRSC" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label2" runat="server" Text="VRSC" Font-Names="Arial" Font-Size="XX-Large" 
     ...
     <br />
        ...
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label6" runat="server" Text="The Harley Davidson VRSC is a great two wheeler to own. It is a bike with all the latest technical features which are making it a rage among the youngsters. The bike
          " Font-Size="Medium" ForeColor="#666666"></asp:Label>
       
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label7" runat="server" 
            Text=" looks heavy but it is easy to control . The Harley Davidson VRSC is loaded with gorgeous styling, superior comfort and host of latest tech features like ExhausTEC and a mechanism" 
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label10" runat="server" 
            Text="Harley Davidson VRSC Sports is a fuel efficient sports bike. It has liquid cooling and “electric-start” features; that is the reason that it consumes less fuel. Normally" 
            ForeColor="#666666"></asp:Label>
         
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label11" runat="server" 
            Text="Harley Davidson VRSC  Sports provides a mileage of 8.7 kmpl with gasoline. It has a fuel tank capacity of 21 litres, which is enough to last for more than 150km. It has a nice" 
            ForeColor="#666666"></asp:Label>
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label12" runat="server" 
         ForeColor="#666666" 
         Text="acceleration as it comes with a 1560cc engine that provides dynamic transmission.Harley Davidson VRSC Sports has a four stroke engine that offers zipper acceleration."></asp:Label>
     <br />
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label14" runat="server" ForeColor="#666666" 
         Text="It is priced at"></asp:Label>
     &nbsp;<asp:Label ID="Label13" runat="server" Text="Rs : 1980000 ." 
        ...
        <asp:Image ID="Image3" runat="server" Height="265px" Width="430px" 
            ImageUrl="~/BikeImages/sports/Harley VRSC-1.jpg" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Image ID="Image4" runat="server" Height="265px" Width="430px" 
            ImageUrl="~/BikeImages/sports/Harley VRSC-2.jpg" />
        <br />
        <br />
        <br />
        <br />
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label9" runat="server" Text="Harley Davidson VRSC  Color" 
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label15" runat="server" ForeColor="#666666" 
         Text=" The state of the art technology offered by Harley Davidson, makes Harley Davidson VRSC a bike with a difference. It has better maneuverability and it makes its owner proud."></asp:Label>
     <br />
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     <asp:Label ID="Label17" runat="server" 
         Text=" better vision at night and at the same time, they look extremely good too. The look of Harley Davidson VRSC is bound of attract eyeballs." 
         ForeColor="#666666"></asp:Label>
     <br />
     <br />
    ...
    <ContentTemplate>
      ...
      <table width="100%" style="height: 286px">
        ...
        <td>
         ...
         <asp:Panel ID="Panel3" runat="server" Width="470px" BackImageUrl="~/BikeImages/sports/Harley VRSC-2.jpg" 
                Height="258px">
        </asp:Panel>
        </td>
        <td>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button1" runat="server" Height="55px"  
                Width="76px" BackColor="#CC3300" BorderStyle="None" 
                ToolTip="Barcelona Red" />
            <br />
            <br />
            <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button2" runat="server" Height="55px" 
                Width="76px" BackColor="#999999" BorderStyle="None" 
                ToolTip="Silver Mica" />
            </td>
       </tr>
     </table>
...
<asp:panel ID="Panel4" runat="server" Height="26px" Width="806px" 
        BackColor="#CCCCCC" BorderColor="White" BorderStyle="Outset">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label18" runat="server" Text="Harley Davidson VRSC  Engine Specifications/Features" 
        Font-Bold="True" Font-Names="Arial"></asp:Label>
    </asp:panel>
    <br />
     <br />
...
<td align="left">                  
 ...
 <td class="style3"></td>                             
 <td align="center"> 
   <asp:Table ID="Table1" runat="server" Width="528px" BorderWidth="1" 
    ...
    <asp:TableRow>
    <asp:TableCell>Harley Davidson VRSC </asp:TableCell>
    <asp:TableCell> Displacement : 1140cc <br />
                    Engine :1560,Type V-Twin  <br />
                    Maximum Power :184Bhp with 10000 rpm <br />
                    Maximum Torque :127 Nm with 8000 rpm <br />
                    Gears :6 Manual gears
     </asp:TableCell>
    <asp:TableCell>Rs 1980000 </asp:TableCell>
    </asp:TableRow>
   ...
   <td>
       <asp:Panel ID="Panel5" runat="server" Height="238px" Width="421px" 
           ...
           <asp:Label ID="Label19" runat="server" Font-Bold="True" Font-Names="Aparajita" 
               Font-Size="X-Large" Text="Features of Harley Davidson VRSC" Font-Underline="True" 
           ...
           <asp:Label ID="Label23" runat="server" Font-Names="Aparajita" 
               Font-Size="X-Large" 
               Text="33 mm front fork for better shock absorbing." ForeColor="#000099"></asp:Label>
           <br />
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; *&nbsp;
