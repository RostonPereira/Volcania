<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bikecompare.aspx.cs" Inherits="Bikecompare" %>
 ...
 <%--both Panel center--%>
    ...
    <td class="style1">
       ...
       <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
               CellPadding="0" GridLines="None" Height="16px" ShowHeader="False">
       <Columns>
       <asp:TemplateField>
       <ItemTemplate>
        <img src="HandlerImage.ashx?autoid=<%# Eval("name").ToString() %>" width="150" height="100" alt="no image" />
  ...
  <%--Internal Table 2--%>
    ...
    <td>
        ...
        Font-Size="Large" GridLines="Both" BackColor="Silver" ForeColor="#000099" 
         BorderStyle="Groove" Height="285px">
    <asp:TableRow>
    <asp:TableHeaderCell>Displacement</asp:TableHeaderCell>
